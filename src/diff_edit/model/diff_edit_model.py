...
class DiffEdit:
    def __init__(self, tokenizer: CLIPTokenizer = None,
        ...
        self.mask_generator = MaskGenerator(unet, scheduler, tokenizer, text_encoder, self.image_processor, torch_device)
    ...
    def get_mask(self, im_path: str, p1: str, p2: str, seed: int = TORCH_SEED, n: int = 10):
        ...
        mask = self.mask_generator.calc_diffedit_diff(im_latent, p1, p2, n, seed)
        return self.mask_generator.processed_mask, self.mask_generator.rough_mask, self.image_processor.get_blended_mask(im, mask)
    ...
    def demo_diffedit(self, im_path: str, p1: str, p2: str, n: int = 2, seed: int = TORCH_SEED):
        """
        ...
        logging.debug(f"Obtaining the mask by running the diffusion process {n} times.")
        ...
        out.append(self.inpainter.inpaint_mask(im, mask, p2, seed))
        return out
